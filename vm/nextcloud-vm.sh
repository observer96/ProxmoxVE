...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/observer96/ProxmoxVE/refs/heads/nvidia-regression/misc/api.func)
...
<div align='center'>
  <a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'>
    <img src='https://raw.githubusercontent.com/observer96/ProxmoxVE/refs/heads/nvidia-regression/misc/images/logo-81x112.png' alt='Logo' style='width:81px;height:112px;'/>
  </a>
