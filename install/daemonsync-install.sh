...
curl -fsSL "https://raw.githubusercontent.com/observer96/ProxmoxVE/refs/heads/nvidia-regression/tools/addon/daemonsync_2.2.0.0059_amd64.deb" -o "daemonsync_2.2.0.0059_amd64.deb"
